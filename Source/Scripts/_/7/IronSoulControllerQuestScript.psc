...
Function RescheduleIfJobsRemain()
	if _pendingDisableRespawn || _revivePending || _postResurrectRecastPending || _pendingLoadMessage || _pendingStartupMessage 
		QueueUpdate(0.10)
	else
    ...
    if _pendingLoadMessage && !_disableLoadMessage
        if Utility.GetCurrentRealTime() >= _loadMessageAt
            ...
            if deaths >= _maxLives
                ...
                Debug.Notification("Your Iron Soul endures. Name: " + name + " Deaths: " + deaths)
